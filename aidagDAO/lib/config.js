export const IS_TESTNET = process.env.NEXT_PUBLIC_NETWORK_MODE === "testnet" || parseInt(process.env.NEXT_PUBLIC_CHAIN_ID) === 97;

export const CHAINS = {
  BSC: {
    id: IS_TESTNET ? 97 : 56,
    name: IS_TESTNET ? "BSC Testnet" : "Binance Smart Chain",
    symbol: "BNB",
    rpc: process.env.NEXT_PUBLIC_BSC_RPC,
    explorer: IS_TESTNET ? "https://testnet.bscscan.com" : "https://bscscan.com",
    active: true
  },
  ETH: {
    id: 1,
...
export const BSC_CHAIN_ID = parseInt(process.env.NEXT_PUBLIC_CHAIN_ID) || (IS_TESTNET ? 97 : 56);
...
export const DAO_MEMBERSHIP_FEE = parseFloat(process.env.NEXT_PUBLIC_DAO_MEMBERSHIP_FEE) || 10;
